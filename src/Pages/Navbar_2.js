...
<nav className="navbar navbar-expand-lg   navbar-dark bg-dark">
        <div className="container-fluid">
            ...
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
               ...
               <img src="cart1.png" alt="cart" height="30px" width="30px"  onClick={navigateToCart} style={{position:'relative',cursor:'pointer',transition:'transform 0.3s ease-in-out',transform: isHovered ?'scale(1.2)':'scale(1)'}} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}/>
